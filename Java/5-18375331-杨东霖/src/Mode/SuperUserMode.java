...
import static Mode.ParsingTerminal.*;
...
public class SuperUserMode {
    ...
    private String judgeNew_(String[] arg, PersonType type) {//Extraction
        if (arg.length == 5) {
    ...
    private String judgeDel_(String[] arg, PersonType type) {//Extraction
        if (arg.length == 2) {
