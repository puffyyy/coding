...
*/
    ...
    private static void parse_superUserMode(String[] arg) {
        if (arg.length == 1) {
            ...
            superUserMode.sudoMode(Cache.scanner);
        } else System.out.println("Params' count illegal");
    }
    ...
    public static void parse_np(String[] arguments) {
    ...
    public static void parse_udd(String[] arguments) {
    ...
    public static void parse_nd(String[] arguments) {
        Menu menu = Menu.getInstance();
        double price;
        int total;
    ...
    public static void parse_pm(String[] arguments) {
        Menu menu = Menu.getInstance();
    ...
    public static void parse_gd(String[] arguments) {
        Menu menu = Menu.getInstance();
