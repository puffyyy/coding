...
//        setPreferredSize(new Dimension(100, 64));
    ...
    private void initView() {
        ...
        add(nameBrief, new GBC(1, 0).setWeight(100, 1).setFill(GBC.BOTH).setInsets(0, 5, 0, -5));
        add(timeUnread, new GBC(2, 0).setWeight(1, 1).setFill(GBC.BOTH).setInsets(0, 0, 0, -5));
    }
