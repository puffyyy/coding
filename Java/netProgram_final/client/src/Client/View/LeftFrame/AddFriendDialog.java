...
public class AddFriendDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        searchButton = new MyScrollBarUI.MyButton("搜索", Colors.MAIN_COLOR, Colors.MAIN_COLOR_DARKER, Colors.MAIN_COLOR_DARKER);
        ...
        okButton = new MyScrollBarUI.MyButton("添加", Colors.MAIN_COLOR, Colors.MAIN_COLOR_DARKER, Colors.MAIN_COLOR_DARKER);
