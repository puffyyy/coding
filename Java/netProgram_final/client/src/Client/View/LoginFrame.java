...
//        MainLoginFrame.pack();
    ...
    public void preDate() {
        ...
        try {
            File f = new File("./cache/client.properties");
            if (!f.exists()) {
                if(!new File("./cache").exists())
                    new File("./cache").mkdir();
                f.createNewFile();
            }
//            System.out.println((String.valueOf(getClass().getResource("/image/client.properties"))));String.valueOf(getClass().getResource("/client.properties")).substring(10))
//            System.out.println(LoginFrame.class.getClassLoader().getResource("./client.properties"));
            InputStream in = new FileInputStream("./cache/client.properties");
            pro.load(in);
    ...
    public void writeDate(String key, String val) {
        ...
        try {
//            InputStream in = new FileInputStream((String.valueOf(getClass().getResource("/client.properties")).substring(10)));
            InputStream in = new FileInputStream("./cache//client.properties");
            pps.load(in);
            in.close();
            pps.put(key, val);
            OutputStream out = new FileOutputStream("./cache//client.properties");
