<template>
  ...
  >
    ...
    <el-form-item prop="confirmPassword" style="width: 80%; margin-left: 30px">
      <el-input
        type="password"
    ...
    <el-form-item prop="email" style="width: 80%; margin-left: 30px">
      <el-input
        type="text"
    ...
    <el-form-item style="width: 70%; margin-left: 45px; border-radius: 15px">
      <el-button
        type="primary"
        style="
          width: 100%;
