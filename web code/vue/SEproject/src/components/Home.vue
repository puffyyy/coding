  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      <div class="topbar-logo topbar-btn">
        <a href="javascript:"
          ><img src="../assets/book.png" style="padding-left: 8px"
        /></a>
      </div>
      <div class="topbar-logos" v-show="!collapsed">
        <a href="javascript:"><img src="../assets/booklogo.png" /></a>
      </div>
      <div class="topbar-title" v-show="collapsed">
          ...
          >
            ...
            <el-menu-item
              v-else-if="
                ...
                !(item.children[0].name == '用户列表' && identity == 'reader')
              "
...
.container {
  ...
  .topbar-wrap {
    ...
    .topbar-title {
      ...
      width: 200px;
      padding-left: 10px;
      border-left: 1px solid rgb(129, 230, 187);
    }
    .topbar-account {
      float: right;
      padding-right: 12px;
