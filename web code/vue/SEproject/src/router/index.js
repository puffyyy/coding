...
import BookReserveList from '@/components/book/reserve'
...
let router = new Router({
    ...
    },
    {
        ...
        children: [
            ...
            { path: '/book/reserve', component: BookReserveList, name: '预约管理', menuShow: true }
        ]
    },
    {
        path: '/home',
    ...
    { path: '/register', component: Register, name: '注册', menuShow: false }
    ]
})
